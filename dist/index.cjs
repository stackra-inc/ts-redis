...
var tsCache = require('@stackra/ts-cache');
...
exports.RedisManager = class _RedisManager extends tsSupport.MultipleInstanceManager {
  static {
  ...
  */
  logger = new tsLogger.Logger(_RedisManager.name);
  /**
  ...
  */
  async createDriverAsync(_driver, config) {
    ...
    try {
      ...
      this.emit(contracts.REDIS_EVENTS.CONNECTED, {
        connection: connectionName
      });
      return conn;
    } catch (err) {
      this.emit(contracts.REDIS_EVENTS.ERROR, {
        connection: connectionName,
  ...
  async disconnect(name) {
    ...
    if (this.hasInstance(connectionName)) {
      ...
      try {
        ...
        this.emit(contracts.REDIS_EVENTS.DISCONNECTED, {
          connection: connectionName,
          reason: "manual"
        });
      } catch (err) {
...
exports.RedisManager = _ts_decorate([
  tsContainer.Injectable(),
  _ts_param(0, tsContainer.Inject(contracts.REDIS_CONFIG)),
  _ts_param(1, tsContainer.Inject(contracts.REDIS_CONNECTOR)),
  _ts_param(2, tsContainer.Optional()),
  _ts_param(2, tsContainer.Inject(contracts.EVENT_EMITTER)),
...
exports.UpstashConnector = class UpstashConnector {
  static {
  ...
  */
  async connect(config) {
    ...
    const client = new redis$1.Redis({
      url: config.url,
      token: config.token,
      retry: config.retry,
...
exports.UpstashConnector = _ts_decorate2([
  tsContainer.Injectable()
], exports.UpstashConnector);
...
var RedisCacheStore = class _RedisCacheStore {
  ...
  logger = new tsLogger.Logger(_RedisCacheStore.name);
...
RedisCacheStore = _ts_decorate3([
  ...
  tsContainer.Injectable(),
  _ts_param2(1, tsContainer.Inject(contracts.REDIS_CONFIG)),
  _ts_metadata2("design:type", Function),
  _ts_metadata2("design:paramtypes", [
    typeof exports.RedisManager === "undefined" ? Object : exports.RedisManager,
    typeof RedisModuleOptions === "undefined" ? Object : RedisModuleOptions
  ])
], RedisCacheStore);
...
exports.RedisModule = class _RedisModule {
  static {
  ...
  */
  static logger = new tsLogger.Logger(_RedisModule.name);
  /**
  ...
  */
  static hasCredentials() {
    try {
      const url = String(tsSupport.env("VITE_UPSTASH_REDIS_REST_URL", "") ?? "").trim();
      const token = String(tsSupport.env("VITE_UPSTASH_REDIS_REST_TOKEN", "") ?? "").trim();
  ...
  */
  static forRoot(config) {
    ...
    return {
      ...
      providers: [
        {
          provide: contracts.REDIS_CONFIG,
          useValue: config
        },
        {
          provide: exports.RedisManager,
          useClass: exports.RedisManager
        },
        {
          provide: contracts.REDIS_MANAGER,
          useExisting: exports.RedisManager
        },
        {
          provide: contracts.REDIS_CONNECTOR,
          useClass: exports.UpstashConnector
        },
...
exports.RedisModule = _ts_decorate4([
  tsContainer.Global(),
  tsContainer.Module({})
], exports.RedisModule);
...
var InjectRedis = /* @__PURE__ */ __name((connectionName) => tsContainer.Inject(getRedisConnectionToken(connectionName)), "InjectRedis");
var InjectRedisManager = /* @__PURE__ */ __name(() => tsContainer.Inject(contracts.REDIS_MANAGER), "InjectRedisManager");
function useRedis() {
  return react.useInject(exports.RedisManager);
}
__name(useRedis, "useRedis");
function useRedisConnection(name) {
  const redis2 = react.useInject(exports.RedisManager);
...
var redis = tsContainer.inject(exports.RedisManager);

exports.InjectRedis = InjectRedis;
exports.InjectRedisManager = InjectRedisManager;
exports.RedisConnectionError = RedisConnectionError;
exports.RedisError = RedisError;
exports.RedisModuleOptionsError = RedisModuleOptionsError;
exports.RedisStore = RedisStore;
exports.UpstashConnection = UpstashConnection;
exports.defineConfig = defineConfig;
exports.getRedisConnectionToken = getRedisConnectionToken;
exports.redis = redis;
exports.useRedis = useRedis;
exports.useRedisConnection = useRedisConnection;
